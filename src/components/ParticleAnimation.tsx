...
export default function ParticleAnimation() {
  ...
  useEffect(() => {
    ...
    function createInitialParticles() {
      ...
      const particleCount = Math.floor(baseParticleCount * Math.sqrt((canvas.width * canvas.height) / (1920 * 387)))
    ...
    function animate() {
      ...
      const targetParticleCount = Math.floor(baseParticleCount * Math.sqrt((canvas.width * canvas.height) / (1920 * 387)))
